...
public class Viewer {
    ...
    public Viewer(Stage primaryStage, int viewer_x, int viewer_y, int viewer_width, int viewer_height){
        ...
        this.pane.setStyle("-fx-background-image: url('file:resources/images/background.jpg');");
